// Импортируем задачи из папки problems
...
//console.log(problem1(2,3));
//console.log(problem2('abcddba'));
//console.log(problem3('aaabccddabab'));
//console.log(problem4('aaabccddababbb', 3));
//console.log(problem5([2, 1, 4, 5, 3]));
console.log(problem6([20, 1, 41, 5, 300]));